...
pub fn execute(allocator: std.mem.Allocator, vm_io: lil.VmIo, file_path: []const u8, init: std.process.Init) !void {
    ...
    try host.executeScript(allocator, vm_io, source, init);
}
